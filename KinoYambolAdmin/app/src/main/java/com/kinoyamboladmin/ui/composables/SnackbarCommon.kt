    ...
    LaunchedEffect(
        ...
        when (informationState) {
            is InformationStateUiState.Information -> snackbarHostState.showSnackbar(
                message = informationState.message.asString(context),
...
fun SnackbarCommon(
    ...
    when(informationState) {
        is InformationStateUiState.Information -> {
            SnackbarInfo(
                informationMessage = informationState.message.asString(context),
                showProgress = informationState.showProgress
            )
        }
        is InformationStateUiState.Error -> {
            SnackbarError(
                errorMessage = informationState.message.asString(context),
